...
import net.swofty.type.lobby.tab.LobbyServerModule;
...
public class TypeLobbyLoader implements SkyBlockTypeLoader {
    @Override
    ...
    public void onInitialize(MinecraftServer server) {
        Logger.info("TypeLobby initialized!");
    }
    ...
    public List<SkyBlockVillagerNPC> getVillagerNPCs() {
        return new ArrayList<>(SkyBlockGenericLoader.loopThroughPackage(
                "net.swofty.type.lobby.villagers",
