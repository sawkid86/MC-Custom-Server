package net.swofty.type.lobby.tab;
...
public class LobbyServerModule extends TablistModule {
    @Override
    public List<TablistEntry> getEntries(SkyBlockPlayer player) {
        ...
        entries.add(new TablistEntry("§b§lArea: §7Lobby", TablistSkinRegistry.GRAY));
