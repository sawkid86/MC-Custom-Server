...
import net.swofty.type.limbo.tab.LimboServerModule;
...
public class TypeLimboLoader implements SkyBlockTypeLoader {
    @Override
    ...
    public void onInitialize(MinecraftServer server) {
        Logger.info("TypeLimbo initialized!");
    }
    ...
    public List<SkyBlockVillagerNPC> getVillagerNPCs() {
        return new ArrayList<>(SkyBlockGenericLoader.loopThroughPackage(
                "net.swofty.type.limbo.villagers",
