package net.swofty.type.limbo.tab;
...
public class LimboServerModule extends TablistModule {
    @Override
    public List<TablistEntry> getEntries(SkyBlockPlayer player) {
        ...
        entries.add(new TablistEntry("§b§lArea: §7Limbo", TablistSkinRegistry.GRAY));
