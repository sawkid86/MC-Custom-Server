    ...
    public void initialize(MinecraftServer server) {
        ...
        loopThroughPackage("net.swofty.types.generic.command.commands", SkyBlockCommand.class).forEach(command -> {
            ...
            if (commandName == null || commandName.trim().isEmpty()) {
                System.out.println("Empty command name detected in class: " + command.getClass().getName());
                System.out.println("Command details: " + cmd.toString());
            } else if (MinecraftServer.getCommandManager().getCommand(commandName) != null) {
                System.out.println("Duplicate command detected: " + commandName + " in class: " + command.getClass().getName());
            } else {
                System.out.println("Registering command: " + commandName + " from class: " + command.getClass().getName());
                try {
                    MinecraftServer.getCommandManager().register(cmd);
                } catch (IllegalStateException e) {
                    System.out.println("Error while registering command: " + commandName + " from class: " + command.getClass().getName());
